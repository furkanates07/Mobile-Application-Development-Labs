...
import com.example.week_9.placeholder.PlaceholderContent.PlaceholderItem;
import com.example.week_9.databinding.FragmentNoteBinding;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (null != listener) {
                    listener.onSelected(holder.mItem);
                }
            }
        });
        if(position % 2 == 1){
